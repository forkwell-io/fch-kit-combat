...
@Component({
  selector: 'app-agency-incoming-contributions',
  templateUrl: './agency-incoming-contributions.component.html',
  styleUrls: ['./agency-incoming-contributions.component.scss']
})
export class AgencyIncomingContributionsComponent implements OnInit {
